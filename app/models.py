...
class Product:
    ...
    def import_from_json(self):
        ...
        self.product_name = product_name['product_name']
        self.opinions_count = opinions_count['opinions_count']
        self.pros_count = pros_count['pros_count']
        self.cons_count = cons_count['cons_count']
        self.average_score = average_score['average_score']
        opinions = product['opinions']
        for opinion in opinions : self.opinions.append(Opinion(**opinion))
